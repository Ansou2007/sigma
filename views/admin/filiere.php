...
<button type="button" class="btn btn-primary" name="add" id="add">Ajouter Filiére</button>
<br>
</br>
	
												
<!--MODAL-->		
	<div class="modal fade" tabindex="-1" id="filiere"  role="dialog"  aria-hidden="true">
	<div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
	  <div id="alerte"></div>
        <h5 class="modal-title">FILIERE</h5>
...
<script>
	...
	$('#filiere').modal('show');
	$('#formulaire')[0].reset();
	$('.modal-title').text("Ajout Filiere");
	$('#action').val('ajout');
