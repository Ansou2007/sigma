...
<head>
    ...
    <!--====== Slick css ======-->
    <link rel="stylesheet" href="<?php echo base_app?>/include/css/slick.css">

    <!--====== Animate css ======-->
    <link rel="stylesheet" href="<?php echo base_app?>/include/css/animate.css">
    
    <!--====== Nice Select css ======-->
    <link rel="stylesheet" href="<?php echo base_app?>/include/css/nice-select.css">
    
    <!--====== Nice Number css ======-->
    <link rel="stylesheet" href="<?php echo base_app?>/include/css/jquery.nice-number.min.css">

    <!--====== Magnific Popup css ======-->
    <link rel="stylesheet" href="<?php echo base_app?>/include/css/magnific-popup.css">

    <!--====== Bootstrap css ======-->
    <link rel="stylesheet" href="<?php echo base_app?>/include/css/bootstrap.min.css">
    
    <!--====== Fontawesome css ======-->
    <link rel="stylesheet" href="<?php echo base_app?>/include/css/font-awesome.min.css">
    
    <!--====== Default css ======-->
    <link rel="stylesheet" href="<?php echo base_app?>/include/css/default.css">
    
    <!--====== Style css ======-->
    <link rel="stylesheet" href="<?php echo base_app?>/include/css/style.css">
    
    <!--====== Responsive css ======-->
    <link rel="stylesheet" href="<?php echo base_app?>/include/css/responsive.css">
...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
    ...
    <!--====== jquery js ======-->
    <script src="<?php echo base_app?>/include/js/vendor/modernizr-3.6.0.min.js"></script>
    <script src="<?php echo base_app?>/include/js/vendor/jquery-1.12.4.min.js"></script>

    <!--====== Bootstrap js ======-->
    <script src="<?php echo base_app?>/include/js/bootstrap.min.js"></script>
    
    <!--====== Slick js ======-->
    <script src="<?php echo base_app?>/include/js/slick.min.js"></script>
    
    <!--====== Magnific Popup js ======-->
    <script src="<?php echo base_app?>/include/js/jquery.magnific-popup.min.js"></script>
    
    <!--====== Counter Up js ======-->
    <script src="<?php echo base_app?>/include/js/waypoints.min.js"></script>
    <script src="<?php echo base_app?>/include/js/jquery.counterup.min.js"></script>
    
    <!--====== Nice Select js ======-->
    <script src="<?php echo base_app?>/include/js/jquery.nice-select.min.js"></script>
    
    <!--====== Nice Number js ======-->
    <script src="<?php echo base_app?>/include/js/jquery.nice-number.min.js"></script>
    
    <!--====== Count Down js ======-->
    <script src="<?php echo base_app?>/include/js/jquery.countdown.min.js"></script>
    
    <!--====== Validator js ======-->
    <script src="<?php echo base_app?>/include/js/validator.min.js"></script>
    
    <!--====== Ajax Contact js ======-->
    <script src="<?php echo base_app?>/include/js/ajax-contact.js"></script>
    
    <!--====== Main js ======-->
    <script src="<?php echo base_app?>/include/js/main.js"></script>
    
    <!--====== Map js ======-->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDC3Ip9iVC0nIxC6V14CKLQ1HZNF_65qEQ"></script>
    <script src="<?php echo base_app?>/include/js/map-script.js"></script>
